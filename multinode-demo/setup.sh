...
solana-keygen -o "$SOLANA_CONFIG_DIR"/mint-id.json
solana-keygen -o "$SOLANA_CONFIG_DIR"/bootstrap-leader-id.json
solana-keygen -o "$SOLANA_CONFIG_DIR"/bootstrap-leader-vote-id.json
